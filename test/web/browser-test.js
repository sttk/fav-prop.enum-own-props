...
var getOwnProps = fav.prop.enumOwnProps;

describe('fav.prop.enumOwnProps', function() {

  it('Should get all props when the argument is a plain object', function() {
    expect(getOwnProps({})).to.deep.equal([]);
    expect(getOwnProps({ a: 1, b: true, c: 'C' })).to.deep
      .equal(['a', 'b', 'c']);
  });
  ...
  it('Should not get properties of prototype', function() {
    function Fn0() {}
    Fn0.prototype.a = 1;
    expect(getOwnProps(new Fn0())).to.deep.equal([]);
    function Fn1() {
      this.b = true;
      this.c = 'C';
    }
    ...
    Fn1.prototype.d = 'D';
    expect(getOwnProps(new Fn1())).to.deep.equal(['b', 'c']);
  });
  ...
  it('Should get only enumerable props', function() {
    ...
    expect(getOwnProps(obj)).to.deep.equal(['a']);
  });
});
